...
from . import (ast_utils, error, extmod, infer, makefile, python, typestr,
               virtual)
from .cpp import CPPNamer, OutputMixin, ExpressionVisitorMixin, StatementVisitorMixin
...
class GenerateVisitor(StatementVisitorMixin, ExpressionVisitorMixin, OutputMixin, ast_utils.BaseNodeVisitor):
